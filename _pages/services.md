...
+ 2026: AAAI (SPC), ICLR (AC), AISTATS, CVPR, ACM CCS, ICML, ICICS, SecureComm, IJCAI, ECCV, Usenix Security (Cycle 2), ACISP (Cycle 2), KDD, NeurIPS (AC), ACSAC; 
...
### Editorship
+ Jan. 2026-Now, [Associate Editor](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=6221036), IEEE Transactions on  Cybernetics (TCYB)
